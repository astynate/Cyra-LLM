...
class TransformerBlock():
    ...
    def __init__(self, embedding_dim, num_heads, feed_forward_dim):
        ...
        self.linear_input = Dense(feed_forward_dim, activation="relu", kernel_initializer='glorot_uniform')
        self.linear_output = Dense(embedding_dim, kernel_initializer='glorot_uniform')
